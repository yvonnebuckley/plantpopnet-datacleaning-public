...
## code reviewed by Caroline Mckeon 11/03/19
...
if(length(missing_site_code)!=2){#If there is more than two levels, Two populations have the same North coordinates/latitude/Y 
  print("error message; there is an unforseen case in your data. Two populations have the same lattitude, although their site ID is different. Site_code_column_script line 47")}#
...
print("If nothing printed out until now, all raws had a site code information, or their site could be reattributed! Well done")
...
print("The script will now see whether all site codes do match those listed in the summary sheet. The script will automatically change the spelling of the codes CDF and LK to match the spelling on the summary sheet. If another site code appears listed here as a warning, please add a case to correct the spelling of the site code adequately")
...
#On January 28th 2019, the site codes C-DF and LK were not matching the site description (should read CDF and LK1). There is also an empty space after "TG" in the site description sheet. 
