...
###### tidy up
#rm(tocheck2, VA_tr_start, VA, coordval, trans_ns, check1, UR16, UR17, UR, TW_LonStp, TW_LatStr, TW, TNM, TNC, SIT2, SI, SCT2, SC, HR, GB, CDF, 
#   site_checks, err1, check_table, cols_trans, replace1, OR_SS, N_issues, IO, HAS, EE, CH, sites, x3, x4, weird_sites, BG_2016_T2, x2, BG_2016_T1, BG_2016, BG, 
#   has_coords, has_site_coords, na_coords, na_site_coords, x1, site_checks_resolved)
